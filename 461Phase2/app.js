    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 13:
                ...
                _a.label = 14;
            case 14:
                if (!(_i < rangeResults_1.length)) return [3 /*break*/, 38];
            ...
            case 16:
                ...
                minRange = void 0;
                maxRange = void 0;
                if (!(rangeParts.length > 1)) return [3 /*break*/, 19];
            ...
            case 31:
                ...
                if (!(versionNumbers[0] * 100 + versionNumbers[1] * 10 + versionNumbers[2] >= minRange[0] * 100 + minRange[1] * 10 + minRange[2] &&
                    versionNumbers[0] * 100 + versionNumbers[1] * 10 + versionNumbers[2] <= maxRange[0] * 100 + maxRange[1] * 10 + maxRange[2])) return [3 /*break*/, 33];
                return [4 /*yield*/, logger_1.logger.info("version is in range")];
            case 32:
                _a.sent();
                version_2 = result.version;
            ...
            case 38:
                offsetValue = void 0;
                if (!(req.query.offset !== undefined)) return [3 /*break*/, 40];
