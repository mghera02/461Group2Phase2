...
app.post('/upload', upload.single('file'), function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var packageName, AdmZip_1, zip, zipEntries, _i, zipEntries_1, zipEntry, fileContent1, fileContent2, fileContent3, fileContent4, err_1, package_id, s3_response, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 8:
                ...
                if (!(zipEntries && zipEntries.length > 0)) return [3 /*break*/, 19];
                _i = 0, zipEntries_1 = zipEntries;
                _a.label = 9;
            case 9:
                if (!(_i < zipEntries_1.length)) return [3 /*break*/, 18];
                zipEntry = zipEntries_1[_i];
                if (!(zipEntry.entryName == "".concat(packageName, "/package.json"))) return [3 /*break*/, 17];
                _a.label = 10;
            case 10:
            ...
            case 19: return [4 /*yield*/, logger_1.logger.debug('The zip file is empty or corrupted.')];
            case 20:
                _a.sent();
                _a.label = 21;
            case 21: return [4 /*yield*/, rds_handler.add_rds_package_data(req.file.originalname.replace(/\.zip$/, ''), {})];
            case 22:
                package_id = _a.sent();
                if (!(package_id === null)) return [3 /*break*/, 25];
            ...
            case 25: return [4 /*yield*/, logger_1.logger.debug("Uploaded package to rds with id: ".concat(package_id))
            ...
            case 30: return [4 /*yield*/, logger_1.logger.info("Successfully uploaded package with id: ".concat(package_id))];
            case 31:
                _a.sent();
