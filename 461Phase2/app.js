...
app.post('/packages', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 12:
                offsetValue = void 0;
                if (!(req.query.offset !== undefined)) return [3 /*break*/, 14];
            ...
            case 17:
                ...
                return [3 /*break*/, 20];
            case 18: return [4 /*yield*/, rds_handler.match_rds_rows_with_pagination("".concat(packageName), version, true, offsetValue)];
            case 19:
                searchResults = _b.sent();
                _b.label = 20;
            case 20:
